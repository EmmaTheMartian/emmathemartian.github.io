...
do without most of it.");
	...
	button("https://nogginzmart.neocities.org", "https://files.catbox.moe/4u56vg.gif", "nogginzmart's button", 0);
	cml_end();

	cml("p", "Misc");
	cml_new("div class='buttons'");
	button(NULL, "/static/others/e2vial-88x31.gif", "powered by estrogen", 1);
	cml_end();

	cml_noend("br");

	cml_new("details");
	cml("summary", "misc button credits");
	cml_noend("br");
	cml("pre",
		#include "button_credits.inl" /* generated by build.sh */
	);
	cml_end(); /* details */
	...
	cml_new("pre");
	cml("code",
"&lt;a href=\"https://emmelinecoats.com/\"&gt;&lt;img\n\
\tsrc=\"https://emmelinecoats.com/static/button.png\"\n\
\talt=\"emmelinecoats.com\"\n\
\twidth=\"88\" height=\"31\"\n\
\tdecoding=\"async\"\n\
